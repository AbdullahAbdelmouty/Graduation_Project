...
export default function Header(props){
    ...
    useEffect(() => 
    {
        ...
        // popup message
        let popupMessageBefore=document.querySelector(".popMessage")
        let popupMessageBtn=document.querySelector(".popMessage button")
        let popupMessagePara=document.querySelector(".popMessage p")
        ...
        mode.addEventListener("click",()=>{
            ...
            if(window.location.pathname==="/"||window.location.pathname==="/Home"){
                ...
                popupMessageBefore.classList.toggle("dark")
                popupMessageBtn.classList.toggle("dark")
                popupMessagePara.classList.toggle("dark")
